...
export default function CreateIrrigationProfileClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.jumlahPetakTersier) body.jumlahPetakTersier = formData.jumlahPetakTersier;
      if (formData.nilaiIksi) body.nilaiIksi = formData.nilaiIksi;
      if (formData.primaryChannelLength) body.primaryChannelLength = formData.primaryChannelLength;
      if (formData.secondaryChannelLength) body.secondaryChannelLength = formData.secondaryChannelLength;
      ...
      const response = await fetch("/api/admin/irrigation-profiles", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        setError(errorData.message || "Gagal membuat profil irigasi");
      }
    } catch (error) {
      setError("Error membuat profil irigasi");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800">
            Buat Profil Irigasi Baru
          </h1>
          <p className="text-gray-600 mt-2">
            Tambahkan profil irigasi baru untuk sistem irigasi Anda
          </p>
        </div>
